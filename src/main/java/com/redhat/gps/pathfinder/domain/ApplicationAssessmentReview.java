...
//    @DBRef
    ...
    public ApplicationAssessmentReview(String ReviewDate, 
          com.redhat.gps.pathfinder.domain.Assessments Assessments, 
//          ReviewDecisionType ReviewDecision, 
//          ReviewWorkEstimateType ReviewEstimate, 
          String ReviewNotes, 
          String WorkPriority, 
...
//            Objects.equals(ReviewEstimate, that.ReviewEstimate) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, ReviewDate, Assessments, 
//            ReviewDecision, ReviewEstimate, 
            ReviewNotes, WorkPriority, BusinessPriority, Application);
    }
