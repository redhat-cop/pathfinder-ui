...
//        })
.style("fill", function (d) {
            if (d.item.text == "AMBER") {
                return "#FCC200"
            } else if (d.item.text == "GREEN") {
                return "#006400"
            } else if (d.item.text == "RED") {
                return "#ff0000"
            }  else if (d.item.text == "UNKNOWN") {
                return "#808080"
            }  
            })
//        .style("fill", function(d) { console.log(d.item.text); return "#FF0000"})
        .attr("opacity", "0.8");
